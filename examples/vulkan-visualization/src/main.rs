...
fn main() -> ash::prelude::VkResult<()> {
    ...
    let instance = {
        ...
        let layers_names_raw = layer_names
            .iter()
    ...
    let mut allocator = Some(VulkanAllocator::new(&VulkanAllocatorCreateDesc {
    ...
    let mut visualizer = Some(gpu_allocator::visualizer::AllocatorVisualizer::new());
